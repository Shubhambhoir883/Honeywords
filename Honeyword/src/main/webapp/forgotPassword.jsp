<%-- 
    ...
    Created on : 6 Aug, 2015, 4:43:45 PM
    Author     : user
--%>
...
<section class="login">
    ...
    <form action="Login" method="post" enctype="application/x-www-form-urlencoded" >
        <input type="text" required title="Username required" name="email" placeholder="Enter Email" data-icon="U" />
        <input id="password" type="password" required title="Password required" name="password" placeholder="Password" data-icon="x" />
        <input id="password1" type="password" required title="Password required" name="password1" placeholder="Retype Password" data-icon="x" />
        <div class="olvido">
            <div class="col"><a href="register.jsp" title="Register">Register</a></div>
            <div class="col"><a href="#" title="Recover Password">Fotgot Password?</a></div>
        </div>
