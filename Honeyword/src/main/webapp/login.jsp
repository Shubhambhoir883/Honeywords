<%-- 
    Document   : login
    Created on : 6 Aug, 2015, 11:04:45 AM
    Author     : user
--%>
...
<section class="login">
	...
	<div>
	<p id="errorblockspan"><% out.println(session.getAttribute("message")); %></p>
	<h3 id="errorblock" style="color:red;">
	
	
	<% 
	
	/* if(session.getAttribute("message")=="F")
	{
	
	out.println(session.getAttribute("Invalid"));
    ...
    <div class="titulo user">User Login</div>
    
    <form action="Login" method="post" enctype="application/x-www-form-urlencoded" >
        <input type="text" required title="Username required" class="input-block-level validate[required,custom[email]]" name ="email" placeholder="Email" data-icon="U" />
        <input type="password" required title="Password required" name="password" placeholder="Password" data-icon="x" />
        <div class="olvido">
            <div class="col"><a href="register.jsp" title="Ver Carásteres"><button type="button" class="btn btn-primary">Register</button></a></div>
<!--            <div class="col"><a href="forgotPassword.jsp" title="Recuperar Password">Forgot Password?</a></div>-->
        </div>
        <input type="submit" class="enviar" value="Submit">
        </form>
            <br>
            <a class="link" href="adminLogin.jsp" style="color:gold">Link to Admin Login?</a>
            </section>
            <!--<div class="link" style="margin-left: auto;margin-right: auto">-->
...
var x =document.getElementById("errorblockspan").innerText;
