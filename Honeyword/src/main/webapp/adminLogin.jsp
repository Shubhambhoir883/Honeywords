<%-- 
    Document   : adminLogin
    Created on : 12 Aug, 2015, 6:00:22 PM
    Author     : user
--%>
...
<section class="login">
    ...
    <form action="AdminLogin" method="post" enctype="application/x-www-form-urlencoded" >
     
        <input type="text" required title="Username required" name ="username" placeholder="Email" data-icon="U" />
        <input type="password" required title="Password required" name="password" placeholder="Password" data-icon="x" />
        <!--        <div class="olvido">
                    <div class="col"><a href="register.jsp" title="Ver Carásteres">Register</a></div>
                    <div class="col"><a href="forgotPassword.jsp" title="Recuperar Password">Fotgot Password?</a></div>
                </div>--><br>
        <input type="submit" class="enviar" value="Submit">
        <form>
            <br>
            <a class="link" href="login.jsp" style="color:gold">Link to User Login?</a>
            </section>
            <style>
