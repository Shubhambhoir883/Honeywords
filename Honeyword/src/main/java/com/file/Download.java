...
public class Download extends HttpServlet 
{
            ...
            throws ServletException, IOException, SQLException 
    {
        ...
        try 
        {
            ...
            String image = (String) request.getParameter("file_name");
            System.out.println("image: " + image);
            //String filePath = "E:/Test/Download/MYPIC.JPG";
            String filePath = getServletContext().getRealPath("/") + "decoy\\" + image;
            ...
            usdesc = username + " downloaad file";
            acdesc = username + " downloaad file "+image+" from" + ip + " address";
            ...
            //inStream.close();
            outStream.close();
            response.sendRedirect("viewUserFiles.jsp");
            //out.close();
        }
    }
